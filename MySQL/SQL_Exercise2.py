...
Sample table : orders
    ...
    - SELECT * FROM orders where orders.ord_date!='2012-9-10' and orders.salesman_id>5005 or orders.purch_amt>1000
...
Sample table: orders
    ...
    - select ord_no,purch_amt,(purch_amt/6000)*100 as 'Achieved',100-((purch_amt/6000)*100) as 'Unachieved' from orders where purch_amt>3000
...
Sample table : emp_details
    ...
    - SELECT * FROM pepsiemployees.emp_details where Emp_lname='Dosni' or Emp_lname='Mardy'
...
Sample table : emp_details
    ...
    - SELECT * FROM pepsiemployees.emp_details where EMP_DEPT=47 or Emp_dept=63
